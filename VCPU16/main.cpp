...
void singleCPU(int ID)
{
	...
	c.PUT(0, 0b1010000000000000); // R[0] = 0
	c.PUT(1, 0b1010000100000000); // R[1] = 0
	c.PUT(2, 0b1010001000000000); // R[2] = 0
	c.PUT(3, 0b1010001100000000); // R[3] = 0
	c.PUT(4, 0b1010010000000000); // R[4] = 0
	c.PUT(5, 0b1010010100000000); // R[5] = 0
	c.PUT(6, 0b1010011000000000); // R[6] = 0
	c.PUT(7, 0b1010011100000000); // R[7] = 0
